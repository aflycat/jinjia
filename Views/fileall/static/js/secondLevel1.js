...
var busLinesHome =[
  {coords: [[3400, 1700],[-1500,-1500]],lineStyle: {normal: {color: 'red',}},},
 ];
...
function  selectOpationHome(bt,busLines,symbolSize,speed,delay,trailLength){
var optionHome = {
    grid: {
        top: 10,
        left: 10,
    ...
    series: [{
            ...
            effect: {
                // period: 100,image://static/imgs/secondLevel/cc.png
                symbol: 'circle',
                constantSpeed: speed,
                show: true,
                trailLength: trailLength,

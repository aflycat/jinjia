...
//保存
function save_pro() {
    var _url = "/GWServices.asmx/ResetAlarmTab";
    var trueNum = 0;
    //普通任务列表
    var datafrom = "";
...
function onbtnsave2(data, dt) {
    ...
    var _url = "/GWServices.asmx/TimedTaskSer";
...
function table_cirhtml() {
    var _url_cir = "/GWServices.asmx/GainAlarmTab";
        ...
        for (var i = 0; i < proName.length; i++) {
            ...
            for (var j = 0; j < checka.length; j++) {
                if (checka[j] == proName[i][0]) {
                    newRow += "<tr><td><input type='checkbox' checked='checked' id='checkWeek_" + weekx[k] + "_a_" + i + "'/><lable onclick='week_lable(\"" + weekx[k] + "\",\"a\"," + i + ")' value='" + proName[i][1] + "'>" + proName[i][1] + "</lable></td></tr>";
                    ched = true;
                    break;
                }
            }
            if (!ched) {
                newRow += "<tr><td><input type='checkbox' id='checkWeek_" + weekx[k] + "_a_" + i + "'/><lable onclick='week_lable(\"" + weekx[k] + "\",\"a\"," + i + ")' value='" + proName[i][1] + "'>" + proName[i][1] + "</lable></td></tr>";
            }
        }
        ...
        for (var i = 0; i < table_cir.length; i++) {
            ...
            for (var j = 0; j < checkb.length; j++) {
                if (checkb[j] == table_cir[i][0]) {
                    newRow += "<tr><td><input type='checkbox' checked='checked' id='checkWeek_" + weekx[k] + "_b_" + i + "'/><lable onclick='week_lable(\"" + weekx[k] + "\",\"b\"," + i + ")' value='" + table_cir[i][1] + "'>" + table_cir[i][1] + "</lable></td></tr>";
                    ched = true;
                    break;
                }
            }
            if (!ched) {
                newRow += "<tr><td><input type='checkbox' id='checkWeek_" + weekx[k] + "_b_" + i + "'/><lable onclick='week_lable(\"" + weekx[k] + "\",\"b\"," + i + ")' value='" + table_cir[i][1] + "'>" + table_cir[i][1] + "</lable></td></tr>";
            }
        }
        $("#ttk_ul_" + weekx[k] + " tbody").append(newRow);
    }
...
function specFordata() {
    ...
    var newRow = "";
    for (var i = 0; i < proName.length; i++) {
        newRow += "<tr><td><input type='checkbox' id='checkSpec_a_" + i + "'/><lable onclick='checkSpecClick(" + i + ",\"a\")' value='" + proName[i][1] + "'>" + proName[i][1] + "</lable></td></tr>";
    }
    $("#spec_ul tbody").append(newRow);

    newRow = "";
    for (var i = 0; i < table_cir.length; i++) {
        newRow += "<tr><td><input type='checkbox' id='checkSpec_b_" + i + "'/><lable onclick='checkSpecClick(" + i + ",\"b\")' value='" + table_cir[i][1] + "'>" + table_cir[i][1] + "</lable></td></tr>";
    }
    $("#spec_ul tbody").append(newRow);
}
    ...
    if (!data.contains(event.toElement)) {
        ...
        $("#spec_ul tbody tr").each(function (i) {
            if (document.getElementById("checkSpec_a_" + i)) {
                if (document.getElementById("checkSpec_a_" + i).checked) {
                    for (var j = 0; j < proName.length; j++) {
                        if ($(this).find("lable").attr("value") == proName[j][1]) {
        ...
        $("#spec_ul tbody tr").each(function (i) {
            if (document.getElementById("checkSpec_b_" + i)) {
                if (document.getElementById("checkSpec_b_" + i).checked) {
                    for (var j = 0; j < table_cir.length; j++) {
                        if ($(this).find("lable").attr("value") == table_cir[j][1]) {

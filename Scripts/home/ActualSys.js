...
function SysEvtCounts() {
    ...
    var _data = "SnapshotStr=" + $("#btnSnapshot_1").attr("values") + ";" + $("#btnSnapshot_2").attr("values") + ";" + $("#btnSnapshot_3").attr("values") + ";" + $("#btnSnapshot_4").attr("values") + ";" + $("#btnSnapshot_5").attr("values");
